module github.com/game-of-nfts/gon-toolbox

go 1.19

require (
	github.com/BurntSushi/toml v1.2.1
	github.com/irisnet/core-sdk-go v0.1.1-0.20221117064320-655a6a144032
	github.com/irisnet/irismod-sdk-go/nft v0.0.0-20221202062750-3b37f3830835
